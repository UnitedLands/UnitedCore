package org.unitedlands.unitedpvp;

import com.palmergames.bukkit.towny.TownyUniverse;
import com.palmergames.bukkit.towny.event.PlayerEnterTownEvent;
import com.palmergames.bukkit.towny.object.Resident;
import com.palmergames.bukkit.towny.object.Town;
import org.unitedlands.unitedpvp.commands.PvPCmd;
import org.unitedlands.unitedpvp.hooks.Placeholders;
...
public final class UnitedPvP extends JavaPlugin implements Listener {

    public static FileConfiguration Config;
    public static Plugin unitedCore = Bukkit.getPluginManager().getPlugin("UnitedCore");
    ...
    public void onEnable() {
        Bukkit.getPluginManager().getPlugin("UnitedPvP").saveDefaultConfig();
        Config = Bukkit.getPluginManager().getPlugin("UnitedPvP").getConfig();
        ...
        customConfigFile = new File(unitedCore.getDataFolder(), "messages.yml");
